...
import sys, time
leapPath = "/Users/victor/Desktop/Cloud/Dropbox/leap/LeapDeveloperKit/LeapSDK/lib"
sys.path.append(leapPath)
print leapPath + " has been appended library. Enjoy Leap Motion"

import Leap
from Leap import CircleGesture, KeyTapGesture, ScreenTapGesture, SwipeGesture

#c = ExodusIIReader(FileName="/Users/victor/Desktop/Cloud/Dropbox/ParaviewTutorialData/disk_out_ref.ex2")
#c = ExodusIIReader(FileName="/Users/victor/Desktop/Cloud/Dropbox/ParaviewTutorialData/headsq.vti")
#c = ExodusIIReader(FileName="/Users/victor/Desktop/Cloud/Dropbox/ParaviewTutorialData/can.ex2")
c = Cone(Radius=1)
...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        #camera.SetFocalPoint( normal[0] , normal[1], normal[2] ) 
        #camera.Azimuth(3.14)
        #.SetPosition( position[x], position[y]-200, position[z] )  #position[y]-frame.interaction_box.center[y]
...
#         	camera.SetRoll(0)
        ...
        # sl.SliceType.Normal = [ normal[0] , normal[1], normal[2] ]
        Render()
