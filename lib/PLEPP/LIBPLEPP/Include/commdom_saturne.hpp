...
vector<fvm_nodal_t*> CsMeshV;
//fvm_nodal_t         *CsMesh; 
int                  n_CsMesh; 
int *parent_element_num;

  map<int, fvm_element_t>            CsType;
  map<int, fvm_element_t>::iterator  CsTypeIT;   

  map<fvm_element_t, alya_element_t>            Cs2Alya;
  map<fvm_element_t, alya_element_t>::iterator  Cs2AlyaIT;   

  map<alya_element_t, fvm_element_t>            Alya2Cs;
  map<alya_element_t, fvm_element_t>::iterator  Alya2CsIT;   
